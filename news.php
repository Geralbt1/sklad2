<?php require('header.php'); ?>
 ...
 ?>
 <button type='button' class="btn btn-primary" onclick="location.href='add_news.php#center'"style='margin:10px auto;'><i class="glyphicon glyphicon-edit glyphicon-white"></i> Добавить новость</button><br><br>
<?
		 ...
		 $i=1;
		  echo '<table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable">';
			...
			while ($rows=mysqli_fetch_assoc($result)) {
				...
				?>
	 <td>
	 <form method='post' action=''><button type='button' class="btn btn-primary btn-info" onclick="location.href='update_news.php?id=<?echo $rows['id_art'] ?>#center'"style='margin:10px auto;'>Изменить</button></form></td>
	 <?
